...
const ROLES: RoleInfo[] = [
  ...
  { id: "product_strategy", name: "产品策略分析师", description: "关注 AI / 大模型 / 数据要素 / 平台经济" },
  { id: "ai_tool_watcher", name: "AI 工具追踪者", description: "关注 Suno / Runway / HeyGen 等工具的版本更新" },
  { id: "opportunity_hunter", name: "机会猎手", description: "关注比赛征集 / 驻留资助 / 申报截止日期" },
  { id: "legal_compliance", name: "法务 / 合规", description: "关注网络安全 / 数据合规 / 平台责任" },
];

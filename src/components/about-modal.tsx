...
const SOURCES = [
  { label: "国家版权局", desc: "政策法规 · 行政许可 · 版权保护" },
  { label: "文化和旅游部", desc: "演出通知 · 文化产业政策" },
  { label: "国家广播电视总局", desc: "内容监管 · 传播政策" },
  { label: "中国音像著作权集体管理协会 MCSC", desc: "版权授权动态" },
  { label: "中国演出行业协会 CAPA", desc: "赛事 · 演出机会" },
];
        ...
        <>
          <div className="sticky top-0 z-10 flex items-center justify-between border-b border-slate-100 bg-white px-6 py-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="text-base font-semibold text-slate-900">创作者雷达</div>
                <div className="text-xs text-slate-500">Creator Radar · Radar · 2026</div>
              </div>
            </div>
            <button
              type="button"
          ...
          <div className="space-y-6 px-6 py-5">
            <p className="text-sm leading-7 text-slate-600">
              面向独立音乐创作者的行业情报平台。监测国内主要版权与文化政策机构，提取与创作相关的高价值信号（AI工具更新 · 演出机会 · 申报截止 · 版权动态），帮助创作者在信息噪音中抓住真正重要的内容。
            </p>

...
import {
  AlarmClock, Bell, BookOpen, ChartColumn, CircleCheck, ClipboardList, Clock, Flame,
  House, Inbox, Languages, Mail, Mailbox, Moon, Pin, RadioTower, Search, Settings,
  Star, TrendingUp, type LucideIcon,
} from "lucide-react";

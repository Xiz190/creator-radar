...
import {
  Bell, BookOpen, Calculator, ChartColumn, ClipboardList, House, Inbox, Mail, Pin,
...
const settingsMenu: MenuEntry[] = [
  ...
  { href: "/signals", label: "高价值信号", icon: RadioTower, desc: "AI工具更新、演出机会、申报截止预警" },
  ...
  { href: "/method", label: "方法说明", icon: Calculator, desc: "信号识别、评分权重、创作者视角的后台机制说明" },
];

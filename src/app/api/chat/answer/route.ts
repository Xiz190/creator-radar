...
function buildLlmPrompt(
  ...
  const system = [
    lang === "en"
      ? "You are a music creator intelligence assistant. Help independent musicians quickly find useful information from indexed content."
      : "你是音乐创作者情报助手，帮助独立音乐人快速从已入库的内容中找到有用信息。",
    lang === "en"

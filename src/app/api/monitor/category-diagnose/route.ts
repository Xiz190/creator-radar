...
export const SIMULATE_SCENARIOS = [
  ...
  },
  {
    ...
    categories: [
      ...
      { category: "C·申报截止预警", score: 15 },
      { category: "D·行业观察", score: 10 },
      { category: "平台政策/版权", score: 20 },
      { category: "AI音乐生成工具", score: 45 },
      { category: "视频/视觉AI工具", score: 38 },
      { category: "流媒体/发行平台", score: 25 },
      { category: "音乐比赛/节庆", score: 22 },
      { category: "版权/法律", score: 30 },
      { category: "海外市场/国际", score: 18 },
      { category: "噪音词汇", score: 5 },
      { category: "地方/省级/区域", score: 12 },
    ],
  },
  {
...
export async function GET(request: Request) {
  try {
    ...
    const REGION_CATEGORIES = new Set(["地方/省级/区域", "region_general", "region_bjj"]);

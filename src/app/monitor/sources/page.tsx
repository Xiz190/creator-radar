          ...
          {batchOpen ? (
            <div className="mt-5 space-y-4">
              <div className="flex flex-wrap items-center gap-2 text-xs">
                <BatchTab active={batchTab === "text"} onClick={() => setBatchTab("text")}><NotebookPen className="h-3.5 w-3.5" aria-hidden />文本粘贴</BatchTab>
                <BatchTab active={batchTab === "csv"} onClick={() => setBatchTab("csv")}><FileText className="h-3.5 w-3.5" aria-hidden />CSV / TSV 上传</BatchTab>
                <BatchTab active={batchTab === "urls"} onClick={() => setBatchTab("urls")}><Link className="h-3.5 w-3.5" aria-hidden />URL 批量粘贴</BatchTab>
              </div>
              ...
              {batchTab === "text" ? (
                <div className="space-y-3">
                  ...
                  <textarea
                    ...
                    placeholder={
                      'Suno | 更新动态 | 博客 | https://suno.com/blog\nRunway | 产品更新 | changelog | https://runway.com/changelog\nSpotify | 行业动态 | 新闻 | https://newsroom.spotify.com\n# 下面这行是未填大板块的兼容写法\nElevenLabs | 产品博客 | https://elevenlabs.io/blog'
                    }
              ...
              return (
                <article key={departmentName} className="pt-6">
                  ...
                  >
                    ...
                    >
                      <Trash2 className="h-3.5 w-3.5" aria-hidden /> 删除整个来源
                    </button>
                  </header>
                          ...
                          <div className="flex-1">
                            ...
                            <div className="mt-3 flex gap-2 text-xs">
                              <input
                                ...
                                placeholder="输入关键词，多个用逗号分隔，例如：十四五,公共文化,非遗"
